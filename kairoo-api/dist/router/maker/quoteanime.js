...
exports.default = quoteAnimeHandler;
 ...
 */
async function quoteAnimeHandler(req, res) {
    ...
    ctx.font = `700 320px ${_canvas_1.FONT_FAMILY}`;
    ctx.textAlign = 'left';
    ctx.textBaseline = 'top';
    ctx.fillText('"', 40, -60);
    const padding = 100;
    const f = (0, _canvas_1.fitFont)(ctx, text, width - padding * 2, 560, 64, 24);
    ...
    ctx.font = `400 32px ${_canvas_1.FONT_FAMILY}`;
